...
OSRM.DEFAULTS = {
		ROUTING_ENGINES: [
			{	url: 'http://demo.noway.io/api/0000/viaroute',
				timestamp: 'http://demo.noway.io/api/0000/timestamp',
				metric: 0,
				label: '✓escalier, ✓escalator, ✓bloqué UFR',
			},
			{	url: 'http://demo.noway.io/api/0001/viaroute',
				timestamp: 'http://demo.noway.io/api/0001/timestamp',
				metric: 0,
				label: '✓escalier, ✓escalator, ✗bloqué UFR',
			},
			{	url: 'http://demo.noway.io/api/0100/viaroute',
				timestamp: 'http://demo.noway.io/api/0100/timestamp',
				metric: 0,
				label: '✓escalier, ✗escalator, ✓bloqué UFR',
			},
			{	url: 'http://demo.noway.io/api/0101/viaroute',
				timestamp: 'http://demo.noway.io/api/0101/timestamp',
				metric: 0,
				label: '✓escalier, ✗escalator, ✗bloqué UFR',
			},
			{	url: 'http://demo.noway.io/api/1000/viaroute',
				timestamp: 'http://demo.noway.io/api/1000/timestamp',
				metric: 0,
				label: '✗escalier, ✓escalator, ✓bloqué UFR',
			},
			{	url: 'http://demo.noway.io/api/1001/viaroute',
				timestamp: 'http://demo.noway.io/api/1001/timestamp',
				metric: 0,
				label: '✗escalier, ✓escalator, ✗bloqué UFR',
			},
			{	url: 'http://demo.noway.io/api/1100/viaroute',
				timestamp: 'http://demo.noway.io/api/1100/timestamp',
				metric: 0,
				label: '✗escalier, ✗escalator, ✓bloqué UFR',
			},
			{	url: 'http://demo.noway.io/api/1101/viaroute',
				timestamp: 'http://demo.noway.io/api/1101/timestamp',
				metric: 0,
				label: '✗escalier, ✗escalator, ✗bloqué UFR',
			}
		],
	...
	HOST_SHORTENER_URL: '',				// use '' to not use url shortener service
	...
	LANGUAGE: "fr",
	LANGUAGE_USE_BROWSER_SETTING: false,
